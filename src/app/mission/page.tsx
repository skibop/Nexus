...
import { Menu, ArrowRight, Star, X, CodeXml, Book, CircleCheckBig, Sparkles, Zap, Shield, Wallet } from "lucide-react"

const FeatureItem = ({ icon: Icon, title, description, delay }: { icon: React.ElementType; title: string; description: string; delay: number }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center p-8 bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-green-100 transition-all duration-500 hover:shadow-2xl hover:translate-y-[-5px] overflow-hidden">
        ...
        <h3 className="text-2xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent mb-3">{title}</h3>
              ...
              >
                <div className="p-4">
                  ...
                  <nav className="space-y-4">
                    ...
                    <Button className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white hover:from-green-600 hover:to-emerald-700" onClick={() => { router.push("/signup"); setIsMenuOpen(false); }}>Sign up</Button>
                  </nav>
                </div>
              </motion.div>
            </motion.div>
              ...
              >
                ...
                >
                  ...
                  <motion.span 
                    ...
                    animate={{ 
                      textShadow: ["0 0 20px rgba(255,255,255,0)", "0 0 30px rgba(255,255,255,0.5)", "0 0 20px rgba(255,255,255,0)"]
                    }}
          ...
          <section id="values" className="py-32 bg-white relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              >
                ...
                <h2 className="text-base text-green-600 font-bold tracking-wide uppercase mb-4">Our Values</h2>
            ...
            <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:py-32 lg:px-8 relative z-10">
              ...
              >
                ...
                <motion.p
                  ...
                  transition={{ delay: 0.5, duration: 0.8 }}
                >
                  Join thousands who are already transforming their financial future
                </motion.p>
              </motion.div>
            </div>
          </section>
