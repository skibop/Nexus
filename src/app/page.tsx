...
import { CreditCard, PieChart, Smartphone, BarChart2, Star, Menu, ArrowRight, ChevronRight, Sparkles, TrendingUp, Shield, Zap, Wallet } from "lucide-react"
...
const FeatureItem = ({ icon: Icon, title, description }: { icon: React.ElementType; title: string; description: string }) => {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl font-bold text-gray-900 mb-3 text-center group-hover:text-green-700 transition-colors duration-300">{title}</h3>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-green-50/30 to-emerald-50/40">
            ...
            <div className="flex justify-between items-center py-4 md:justify-start md:space-x-10">
              ...
              <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button variant="ghost" className="text-base font-medium text-gray-700 hover:text-green-600 transition-colors" onClick={() => router.push("/login")}>
                    Log in
                  </Button>
                </motion.div>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          ...
          >
            <div className="p-6">
              <div className="flex items-center justify-between mb-8">
                <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-emerald-600">Nexus</h1>
                <Button variant="ghost" onClick={() => setIsMenuOpen(false)} className="hover:bg-green-50">
              ...
              <nav className="space-y-6">
                <a href="#features" className="block text-lg font-medium text-gray-900 hover:text-green-600 transition-colors duration-300 p-3 rounded-lg hover:bg-green-50" onClick={() => setIsMenuOpen(false)}>Features</a>
                <a href="#testimonials" className="block text-lg font-medium text-gray-900 hover:text-green-600 transition-colors duration-300 p-3 rounded-lg hover:bg-green-50" onClick={() => setIsMenuOpen(false)}>Testimonials</a>
              </nav>
              <div className="mt-8">
                <Button className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white hover:from-green-500 hover:to-emerald-500 shadow-lg transform hover:scale-105 transition-all duration-300" onClick={() => { router.push("/signup"); setIsMenuOpen(false); }}>
                  Get Started Now
                </Button>
              </div>
            </div>
      ...
      <main>
          ...
          titleComponent={
            <div className="text-center">
              ...
              <h2 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
                ...
                <span className="block bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-emerald-600">Financial Future</span>
              </h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        <section id="features" className="py-32 bg-gradient-to-br from-white via-green-50/20 to-emerald-50/30 relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="text-5xl font-extrabold tracking-tight text-gray-900 sm:text-6xl mb-6">
                Built for the 
                <span className="block bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-emerald-600">Modern Era</span>
              </h2>
              <p className="max-w-3xl text-xl text-gray-600 lg:mx-auto leading-relaxed">
                Discover cutting-edge tools designed to transform your financial journey with intelligence, security, and style.
              </p>
            </motion.div>
        ...
        <section id="testimonials" className="py-32 bg-gradient-to-br from-gray-900 via-green-900 to-emerald-900 relative overflow-hidden">
          <div className="absolute inset-0">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="text-5xl font-extrabold tracking-tight text-white sm:text-6xl mb-6">
                Loved by 
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-emerald-400"> Thousands</span>
              </h2>
              <p className="max-w-3xl text-xl text-green-100 mx-auto leading-relaxed">
                Join the community of students who've transformed their financial future with Nexus.
              </p>
            </motion.div>
          ...
          <div className="relative max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:py-24 lg:px-8">
            ...
            >
              <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight text-white mb-6">
                Ready to Transform
                <span className="block text-green-200">Your Financial Life?</span>
              </h2>
              <p className="text-xl text-green-100 mb-12 max-w-2xl mx-auto leading-relaxed">
                Join thousands of students who've already discovered the power of intelligent financial management.
              </p>
